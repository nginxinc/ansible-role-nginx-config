[![Ansible Galaxy](https://img.shields.io/badge/galaxy-nginxinc.nginx_config-5bbdbf.svg)](https://galaxy.ansible.com/nginxinc/nginx_config)
[![Build Status](https://travis-ci.org/nginxinc/ansible-role-nginx-config.svg?branch=main)](https://travis-ci.org/nginxinc/ansible-role-nginx-config)
